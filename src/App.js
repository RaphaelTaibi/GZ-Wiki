...
function App() {
  ...
  return (
    <Router>
    <div className="flex flex-col min-h-screen"  style={{ backgroundImage: `url(${backgroundImage})`, minHeight: '100vh', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
      <AppHeader />
      <main className="flex-grow">
        <Routes>
          ...
          <Route path="/quests/faction/:factionId/:questId" element={<QuestDetail />} />
          <Route path="/quests/common/:questId" element={<QuestDetail />} />
          <Route path="/quests/traders/:traderId/:questId" element={<QuestDetail />} />
